...
DO_CALCULATOR: OBJECTS OBJECTS/calc.o OBJECTS/main_calc.o
	$(VR_COMPILER) OBJECTS/calc.o OBJECTS/main_calc.o -o calc $(VR_FLAGS)

#==============================================================================================================================================

OBJECTS/calc.o: CALCULATOR/calc.cpp
	$(VR_COMPILER) -c -o  OBJECTS/calc.o CALCULATOR/calc.cpp $(VR_FLAGS)

OBJECTS/main_calc.o: CALCULATOR/main_calc.cpp
	$(VR_COMPILER) -c -o OBJECTS/main_calc.o CALCULATOR/main_calc.cpp $(VR_FLAGS)
